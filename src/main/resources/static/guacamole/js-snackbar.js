function SnackBar(userOptions){var snackbar=this;var _Interval;var _Message;var _Element;var _Container;var _OptionDefaults={message:"Operation performed successfully.",dismissible:true,timeout:5000,status:"",id:""}
    var _Options=_OptionDefaults;function _Create(){_Container=document.getElementsByClassName("js-snackbar-container")[0];if(!_Container){_Container=document.createElement("div");_Container.classList.add("js-snackbar-container");document.body.appendChild(_Container);}
        ...
        _Message=document.createElement("span");_Message.classList.add("js-snackbar__message");_Message.id = _Options.id;_Message.textContent=_Options.message;innerSnack.appendChild(_Message);if(_Options.dismissible){let closeBtn=document.createElement("span");closeBtn.classList.add("js-snackbar__close");closeBtn.innerText="\u00D7";closeBtn.onclick=Close;innerSnack.appendChild(closeBtn);}
    ...
    var _ConfigureDefaults=function(){if(userOptions===undefined){return;}
        ...
        if(userOptions.id!==undefined){_Options.id=userOptions.id;}

 ...
 *     be added.
 */
Guacamole.HTTPTunnel = function(tunnelURL,id,width,height, crossDomain, extraTunnelHeaders) {
    ...
    var TUNNEL_CONNECT = tunnelURL + "?connect&id="+id+"&width="+width+"&height="+height;
